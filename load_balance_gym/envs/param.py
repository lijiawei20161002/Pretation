...
# -- Load Balance --
parser.add_argument('--num_servers', type=int, default=2, help='number of servers (default: 10)')
#parser.add_argument('--num_servers', type=int, default=10, help='number of servers (default: 10)')
parser.add_argument('--num_stream_jobs', type=int, default=50, help='number of streaming jobs (default: 1000)')
parser.add_argument('--service_rates', type=float, default=[1.0] *2, #(0.15 + (pd.Series(range(100)))*0.1).tolist(), 
